...
import (
	...
	"github.com/szirtesitidom/langchaingo/llms/googleai"
	"github.com/szirtesitidom/langchaingo/llms/googleai/vertex"
)
...
func testMultiContentImageLink(t *testing.T, llm llms.Model) {
	...
	parts := []llms.ContentPart{
		llms.ImageURLPart(
			"https://github.com/szirtesitidom/langchaingo/blob/main/docs/static/img/parrot-icon.png?raw=true",
		),
